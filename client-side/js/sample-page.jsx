      ...
      <Page>
        ...
        <Hero backgroundImage="img/hero-bg-01.jpg"
          ...
          <div class="embed-responsive embed-responsive-16by9">
            <video className="col-12" width="500" height="240" autoPlay loop muted>
          ...
          <div className="neal-signup-inline center col-lg-6 col-md-12">
            {
              this.state.isSubscribed ?
                <div>
                  <div className="alert alert-success notify col-12">
                    You're Now Subscribed
                  </div>
                  <a className="btn btn-outline-info col-12" onClick={this.reSignUp}>Use another email</a>
                </div>
                : this.state.alreadyAmember ? // ? if the user turns out to be a member already
                  <div>
                    <div className="alert alert-danger notify col-12">
                      You're Already Subscribed
                    </div>
                    <button className="btn btn-outline-info col-12" onClick={this.reSignUp}>Use another email</button>
                  </div>
                  :
       ...
       <Section className="nopad-bottom">
        ...
        <Section>
          <HorizontalSplit padding="md">
            <div>
              <p className="lead">what do we do</p>
            ...
            <div>
              <p className="lead">stuff we does the best!</p>
            ...
            <div>
              <p className="lead">other stuff we do</p>
     ...
     <Section>
        <CustomerQuotes>
          ...
          <CustomerQuote name="Elon Musk" imageUrl="img/people/elonmusk.jpg">
            <p>I came to the conclusion that we should aspire to increase the scope and scale of human consciousness in order to better understand what questions to ask. Really, the only thing that makes sense is to strive for greater divlective enlightenment.</p>
          </CustomerQuote>
